...
auth.register("profile", ProfileViewSet, basename="profile") # Профиль текущего пользователя
auth.register("districts", DistrictsViewSet, basename="districts") # Список регионов
auth.register("branches", BranchesViewSet, basename="branches") # Список производственных отралсей
...
urlpatterns = [
    ...
    path("ping/", PingViewSet.as_view(), name="ping"), # Пинг сервера
